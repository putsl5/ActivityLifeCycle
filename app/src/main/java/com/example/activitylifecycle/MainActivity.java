...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("lifeclye", "onCreate invoked ");
    ...
    protected void onStart() {
        super.onStart();
        Log.d("lifeclye", "onStart invoked ");
    ...
    protected void onResume() {
        super.onResume();
        Log.d("lifeclye", "onResume invoked ");
    ...
    protected void onPause() {
        super.onPause();
        Log.d("lifeclye", "onPause invoked ");
    ...
    protected void onRestart() {
        super.onRestart();
        Log.d("lifeclye", "onRestart invoked ");
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.d("lifeclye", "onDestroy invoked ");
